...
public class ModRegistry {
    ...
    public static final XiangqiPieceBlock TEMPLATE = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));


    public static final XiangqiPieceBlock BGENERAL = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock BGUARD = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock BMINISTER = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock BHORSE = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock BROOK = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock BCANNON = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock BSOLDIER = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock RGENERAL = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock RGUARD = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock RMINISTER = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock RHORSE = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock RROOK = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock RCANNON = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final XiangqiPieceBlock RSOLDIER = new XiangqiPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));

    public static final BWPieceBlock WHITEPIECE = new BWPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));
    public static final BWPieceBlock BLACKPIECE = new BWPieceBlock(FabricBlockSettings.of(Material.METAL).strength(1f));

    public static final BoardBlock CORNER = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock TLINE = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock CROSS = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock MARKED_TLINE = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock MARKED_CROSS = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock LEFT_I_TLINE = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock RIGHT_I_TLINE = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ONE_I_CROSS = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock FOUR_I_CROSS = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock POINT_CROSS = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));



    public static final JunqiPieceBlock TEMPLATEJ = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),0);
    public static final JunqiPieceBlock BGONGBING = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),1);
    public static final JunqiPieceBlock BPAIZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),2);
    public static final JunqiPieceBlock BLIANZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),3);
    public static final JunqiPieceBlock BYINGZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),4);
    public static final JunqiPieceBlock BTUANZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),5);
    public static final JunqiPieceBlock BLVZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),6);
    public static final JunqiPieceBlock BSHIZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),7);
    public static final JunqiPieceBlock BJUNZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),8);
    public static final JunqiPieceBlock BSILING = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),9);
    public static final JunqiPieceBlock BJUNQI = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),0);
    public static final JunqiPieceBlock BZHADAN = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),10);
    public static final JunqiPieceBlock BDILEI = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),11);

    public static final JunqiPieceBlock RGONGBING = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),1);
    public static final JunqiPieceBlock RPAIZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),2);
    public static final JunqiPieceBlock RLIANZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),3);
    public static final JunqiPieceBlock RYINGZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),4);
    public static final JunqiPieceBlock RTUANZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),5);
    public static final JunqiPieceBlock RLVZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),6);
    public static final JunqiPieceBlock RSHIZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),7);
    public static final JunqiPieceBlock RJUNZHANG = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),8);
    public static final JunqiPieceBlock RSILING = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),9);
    public static final JunqiPieceBlock RJUNQI = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),0);
    public static final JunqiPieceBlock RZHADAN = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),10);
    public static final JunqiPieceBlock RDILEI = new JunqiPieceBlock(FabricBlockSettings.of(Material.WOOD).strength(1f),11);
    public static final BoardBlock ST_STCAMP = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_STBASE = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_CORNER = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_CROSS = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_CROSS_ONE_RAIL = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_LEFT_L_RAIL = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_LEFT_TOP_T_RAIL = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_ONE_RAIL = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_RIGHT_TOP_T_RAIL = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_RIGHT_L_RAIL = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_TLINE = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_TLINE_ONE_RAIL = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_TV_ONE_RAIL = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_V_CROSS_ONE_RAIL = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_V_CROSS_T_RAIL = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    public static final BoardBlock ST_STBLANK = new BoardBlock(FabricBlockSettings.of(Material.WOOD).strength(1f));
    ...
    public static final ItemGroup XIANGQI_GTOUP = FabricItemGroup.builder(new Identifier(MODID, "xiangqi"))
    ...
    public static final ItemGroup JUNQI_GTOUP = FabricItemGroup.builder(new Identifier(MODID, "junqi"))
